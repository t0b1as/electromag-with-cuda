...
public:
    ...
    public:
         ...
         * unsigned integer value in bits. Currently supported values are 32 or
         * 64 bits.
         */
        cl_uint addressBits;
         ...
         * 
         * Is CL_TRUE if the device is available and CL_FALSE if the device is
         * not available.
         */
        cl_bool available;
         ...
         * to compile the program source. Is CL_TRUE if the compiler is
         * available. This can be CL_FALSE for the embededed platform profile
         * only.
         */
         ...
         *      round to nearest even rounding modesupported.
         * CL_FP_ROUND_TO_ZERO
         ...
         * 
         * Is CL_TRUE if the device implements error correction for the
         * memories, caches, registers etc. in the device. Is CL_FALSE if the
         ...
         * 
         * Describes the execution capabilities of the device. This is a
         ...
         * names themselves do not contain any spaces). The list of extension
         * names returned currently can include one or more of the following
         ...
         * 
         * Describes the OPTIONAL half precision floating-point capability of
         * the OpenCL device. This is a bit-field that describes one or more of
         * the following values:
         * 
         * CL_FP_DENORM
         ...
         * kernel. The minimum value is 128 if CL_DEVICE_IMAGE_SUPPORT is
         * CL_TRUE.
         */
         ...
         * value is 16 if CL_DEVICE_IMAGE_SUPPORT is CL_TRUE.
         * (Also see sampler_t.)
         */
        cl_uint maxSamplers;
         ...
         * for CL_DEVICE_MAX_WORK_ITEM_DIMENSIONS.
         ...
         * supported by the compiler for this device. This version string has
         * the following format:\n
         * OpenCL<space>C<space><major_version.minor_version><space>
         * <vendor-specific information> \n
         * The major_version.minor_version value must be 1.1 if
         ...
         * If OpenCL C 1.1 is returned, this implies that the language feature
         * set defined in section 6 of the OpenCL 1.1 specification is supported
         * by the OpenCL 1.0 device.
         */
    ...
    public:
         ...
         *  profile. The embedded profile is defined to be a subset for each
         * version of OpenCL.
         */
        char profile[256];
